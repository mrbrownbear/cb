...
document.querySelector('.awards-trails').addEventListener('mousemove', handlePointerMove)
document.querySelector('.awards-trails').addEventListener('touchmove', handlePointerMove)
